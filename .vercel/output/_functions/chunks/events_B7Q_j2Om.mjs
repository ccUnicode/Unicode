const proximosEventos = [
  {
    ...
    descripcion: "Un evento en conjunto con Data Science Research Perú donde exploraremos el mundo del dáta, la ciencia de datos y su impacto en el entorno profesional actual.",
    fecha: "23 May",
  ...
  },
  {
    ...
    descripcion: "La segunda edición de la Software Week en la FIIS, un congreso donde conviven profesionales de tecnología y estudiantes. Actividades, charlas, talleres y mucho networking.",
    fecha: "1 – 5 Set",
    hora: "Por definir",
    lugar: "UNI",
    imagenPonente: "/mascota/Mascota-Unicode-Fondo-Individual.webp",
...
const eventosRealizados = [
  {
    titulo: "Tech Day",
    descripcion: "Una jornada sobre el impacto práctico de la IA, Data e Infraestructura Cloud con ponentes expertos. Realizado el 18 de abril en el Auditorio CTIC de la UNI.",
    fecha: "18 Abr 2026",
    asistentes: 60,
    categoria: "Charla",
  ...
  {
    titulo: "BEE Geometry",
    descripcion: "Concurso de geometría que reunió a estudiantes apasionados por las matemáticas, compitiendo en un entorno de razonamiento espacial y pensamiento analítico.",
    fecha: "21 Mar 2026",
    asistentes: 30,
  ...
  },
  {
    ...
    descripcion: "Un encuentro enfocado en casos reales de automatización, predicción y transformación digital liderado por expertos de la industria financiera en Perú.",
    fecha: "18 Dic 2025",
    asistentes: 100,
    categoria: "Summit",
  ...
  },
  {
    ...
    descripcion: "Primera edición de la Software Week en la FIIS, un evento diseñado para fortalecer la cultura de software y el networking en la comunidad universitaria.",
    fecha: "Sep 2025",
    asistentes: 100,
    categoria: "Workshop",
  ...
  },
  {
    ...
    descripcion: "Charla magistral compartiendo lecciones sobre innovación y su trabajo con Steve Jobs como uno de los 12 evangelistas tecnológicos originales de Apple.",
    fecha: "20 Nov 2025",
    asistentes: 120,
    categoria: "Charla",
  ...
  },
  {
    ...
    descripcion: "Actividad donde los miembros del centro pueden conocerse entre si y pasar un buen rato.",
    fecha: "21 Feb 2025",
    asistentes: 20,
  ...
  },
  {
    ...
    descripcion: "Actividad en la que todo UNICODE recibe con ansias a los ingresantes del ciclo 2026-1.",
    fecha: "20 Feb 2026",
    asistentes: 30,
    categoria: "Social",
  ...
  },
  {
    ...
    descripcion: "5 sesiones guiadas por Rolly Mamani Cutipa (Bronce en IOI 2022), donde se aprendieron algoritmos, pensamiento lógico y disciplina tecnológica. Dirigido a estudiantes que quieran unirse al mundo de la Programación Competitiva.",
    fecha: "2 Oct 2022",
    asistentes: 20,
    categoria: "Clase",
  ...
  },
  {
    ...
    descripcion: "Concurso de integrales que reunió a estudiantes de todas las facultades interesados en este tema, mientras participaban por un premio monetario. Más allá del resultado, fue valioso ver el nivel de competitividad sana, constancia y sobre todo disciplina de todos los participantes.",
    fecha: "05 Dic 2025",
    asistentes: 32,
    categoria: "Competencia",
    imagen: "/eventos/bee-integration.jpg",
  ...
  },
  {
    ...
    descripcion: "3 sesiones dedicadas a sembrar mentalidad innovadora, tecnológica y trabajo colaborativo que permitieron que muchos den su primer paso hacia este mundo. Dirigida a los estudiantes que quieran participar por primera vez en una Hackathon.",
    fecha: "22 Nov 2025",
    asistentes: 30,
    categoria: "Clase",
...
export { categoriaBadge as c, eventosRealizados as e, proximosEventos as p };
