...
}, "D:/Carpeta_de_clases_2023-2025/ID-UNICODE/Unicode/src/components/components-areas/AreaCard.astro", void 0);
...
const $$HeroAreas = createComponent(($$result, $$props, $$slots) => {
  ...
  ], "imageSrc": "/areas/AreasThumbnails/id-thumbnail.webp", "data-astro-cid-yfkkhka3": true })} </div> </div> </section> <!-- Levantamiento del título y las cards -->  <!-- Fondo dinámico --> ${renderScript($$result, "D:/Carpeta_de_clases_2023-2025/ID-UNICODE/Unicode/src/components/components-areas/HeroAreas.astro?astro&type=script&index=0&lang.ts")} <!-- más de la mitad de la pantalla es diseño plexus, no espantarse -->`;
}, "D:/Carpeta_de_clases_2023-2025/ID-UNICODE/Unicode/src/components/components-areas/HeroAreas.astro", void 0);
...
}, "D:/Carpeta_de_clases_2023-2025/ID-UNICODE/Unicode/src/pages/areas.astro", void 0);

const $$file = "D:/Carpeta_de_clases_2023-2025/ID-UNICODE/Unicode/src/pages/areas.astro";
const $$url = "/areas";
